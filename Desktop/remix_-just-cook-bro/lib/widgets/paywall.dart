            ...
            : Column(
                children: [
                   ...
                   Expanded(
                     child: ListView.builder(
                       ...
                       itemBuilder: (context, index) {
                         ...
                         // Skip lifetime packages to enforce recurring subscriptions
                         if (package.packageType == PackageType.lifetime) {
                           return const SizedBox.shrink();
                         }

                         // Determine the interval text
                         String intervalText = "";
                         ...
                         return Container(
                           ...
                           child: ListTile(
                             ...
                             trailing: Text(
                               "${package.storeProduct.priceString}$intervalText", 
                               style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFFDAA520))
                             ),
                   ...
                   const Padding(
                     ...
                     child: Text("Recurring billing. Cancel anytime securely via Google Play / App Store.", textAlign: TextAlign.center, style: TextStyle(color: Colors.grey, fontSize: 12)),
                   )
                ],
              ),
    );
